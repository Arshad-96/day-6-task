...
console.log(
  `The circumfrence of Circle is => ${myCircle.getCircumference().toFixed(2)}`
);
...
The radius of Circle is : 1 and the color is : "red"
To get the Radius of Circle is : 1
To ge the Color of Circle is : "red"
Circle => "[radius = 1, color = red]"
The area of Circle is => 3.14
The circumfrence of Circle is => 6.28
set radius and color : 
New : To get the Radius of Circle is : 2
New : To ge the Color of Circle is : "blue"
